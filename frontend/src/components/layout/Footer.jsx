...
const propertyTypes = [
  ...
  { label: 'Studio Flats', href: '/properties?type=Studio' },
  { label: 'PG Accommodation', href: '/properties?type=PG' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2.5 mb-5">
              <div className="w-9 h-9 bg-gradient-to-br from-primary-500 to-violet-600 rounded-xl flex items-center justify-center shadow-glow-sm">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6">
              India's most trusted rental platform. Find your perfect home or list your property with confidence, security, and ease.
            </p>
            {/* Social Links */}
            ...
            <ul className="space-y-3">
              {quickLinks.map((l) => (
                <li key={l.label}>
                  ...
                  >
                    <span className="w-1 h-1 bg-primary-500/50 rounded-full group-hover:bg-primary-400 transition-colors" />
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {['SSL Secure', 'Verified', 'RERA Compliant'].map((b) => (
                <span
                  key={b}
                  className="text-xs px-2.5 py-1 glass rounded-full text-slate-300 border border-white/8"
                >
                  ✓ {b}
                </span>
              ))}
        ...
        <div className="border-t border-white/8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-xs text-center sm:text-left">
            © {new Date().getFullYear()} RentEase Technologies Pvt. Ltd. All rights reserved.
          </p>
